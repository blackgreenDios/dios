...
const URL = "https://teachablemachine.withgoogle.com/models/Ija7finVW/";
...
async function predict() {
    ...
    const pushUp = prediction[1].probability.toFixed(2);
...
goRecord.addEventListener('click', e => {
    ...
    formData.append('pushUpCount', count);
    formData.append('pushUpSetting', goal);
